...
static class MathC
{
    ...
    public static Vector3 WorldToHUDSpace(Camera camera, Vector3 worldObjectPosition, Vector3 referenceObjectPosition){
        ...
        screenPosition.z = (referenceObjectPosition - camera.transform.position).magnitude; //adjust Z to be the correct distance from the camera, based on the given canvas
